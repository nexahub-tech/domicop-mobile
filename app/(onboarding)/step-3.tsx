      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInUp.delay(100).duration(400)} style={styles.visualContainer}>
          ...
          <View style={styles.ghostIconContainer}>
            <MaterialIcons name="groups" size={160} color={`${colors.primary}08`} />
          </View>
          ...
          <View style={styles.illustrationContainer}>
            ...
            <View style={styles.glassCard}>
              <Image
                source={{ uri: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=400&q=80' }}
              ...
              <View style={styles.trendIndicator}>
                <MaterialIcons name="handshake" size={16} color={colors.onPrimary} />
                <Text style={styles.trendText}>Support Active</Text>
              </View>
            </View>
          </View>
        </Animated.View>
        ...
        <Animated.View entering={FadeInUp.delay(200).duration(400)} style={styles.textContainer}>
          <Text style={styles.title}>Join a Thriving Community</Text>
          <Text style={styles.description}>
            Connect with thousands of members building financial success together. Share goals, get support, and grow with the community.
          </Text>
        </Animated.View>
      </View>
